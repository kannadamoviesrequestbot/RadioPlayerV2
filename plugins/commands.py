...
HOME_TEXT = "👋🏻 **Hi [{}](tg://user?id={})**,\n\nI'm **Radio Player Bot** \nI Can Play Radio/Stream Music In Channels & Groups 24x7 Nonstop. Made with ❤️ By @beereshbanakards!"
HELP = """🏷️ **Need Help?** 🤔
__(Join @KANNADAMOVIES_17 For Support)__
...
async def start(client, message):
    ...
    [
        InlineKeyboardButton('MORE BOTS', url='https://t.me/KANNADAMOVIES_17'),
